  ...
  return (
    <div className="fixed inset-0 bg-black/85 backdrop-blur-sm flex items-center justify-center z-[1000] p-4">
      <div className="bg-gradient-to-br from-[rgba(30,30,50,0.95)] to-[rgba(20,20,35,0.98)] border-2 border-white/10 rounded-2xl p-8 md:p-10 min-w-[320px] md:min-w-[400px] max-w-[500px] shadow-[0_0_40px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.1)]">
        <h2 className="font-orbitron text-center text-2xl md:text-3xl font-bold text-white m-0 mb-6 uppercase tracking-[2px] md:tracking-[4px] drop-shadow-[0_0_20px_rgba(100,200,255,0.5)]">
          OPTIONS
        </h2>

        <div className="mb-6">
          <h3 className="font-orbitron text-sm font-bold text-white/60 m-0 mb-4 uppercase tracking-wide border-b border-white/10 pb-2">
            Audio
          </h3>
          ...
          <div className="flex items-center justify-between mb-4">
            <label
              ...
              className="font-orbitron text-base text-white/90"
            >
              Master Volume
            </label>
